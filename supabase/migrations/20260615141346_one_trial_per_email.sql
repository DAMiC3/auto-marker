-- P1-7: one free trial per email address.
...
-- No policies → only SECURITY DEFINER functions / the service role can read or write.
...
-- Enforce the limit inside set_plan (the only writer to profiles).
